                ...
                <ul class="nav nav-pills small">
                    <li class="nav-item">
                        <a href="<?php echo e(route('inventory.dashboard')); ?>"
                           class="nav-link <?php echo e(request()->routeIs('inventory.dashboard') ? 'active' : ''); ?>">
                            Overview
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('inventory.items.index')); ?>"
                           class="nav-link <?php echo e(request()->routeIs('inventory.items.*') ? 'active' : ''); ?>">
                            Browse Items
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('inventory.loans.create')); ?>"
                           class="nav-link <?php echo e(request()->routeIs('inventory.loans.create') ? 'active' : ''); ?>">
                            Lend Item
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('inventory.loans.index')); ?>"
                           class="nav-link <?php echo e(request()->routeIs('inventory.loans.index') ? 'active' : ''); ?>">
                            Loan History
                        </a>
                    </li>
                </ul>
                ...
                <div class="card shadow-soft border-0 h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2 mb-3">
                            <a href="<?php echo e(route('inventory.items.create')); ?>" class="btn btn-outline-primary btn-sm">
                                Add New Item
                            </a>
                            <a href="<?php echo e(route('inventory.items.index')); ?>" class="btn btn-outline-secondary btn-sm">
                                Browse Items
                            </a>
                        </div>
