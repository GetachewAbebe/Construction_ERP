            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                    <div class="badge-modern" style="background: rgba(115, 175, 111, 0.1); color: var(--erp-deep);">
                        ...
                        Updated <?php echo e(now()->format('H:i')); ?>
                    ...
                    <div class="glass-card metric-card-modern p-4" style="--gradient: var(--gradient-primary);">
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            <div class="flex-grow-1">
                                ...
                                <div class="metric-number mb-2"><?php echo e($totalItems ?? 0); ?></div>
                    ...
                    <div class="glass-card metric-card-modern p-4" style="--gradient: var(--gradient-warning);">
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            <div class="flex-grow-1">
                                ...
                                <div class="metric-number mb-2"><?php echo e($lowStockCount ?? 0); ?></div>
                    ...
                    <div class="glass-card metric-card-modern p-4" style="--gradient: var(--gradient-danger);">
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            <div class="flex-grow-1">
                                ...
                                <div class="metric-number mb-2"><?php echo e($outOfStockCount ?? 0); ?></div>
                    ...
                    <div class="glass-card p-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <span class="badge-modern" style="background: rgba(17, 153, 142, 0.1); color: #11998e;">
                                <?php echo e($healthPercentage); ?>% Healthy
                            </span>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="stat-card">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h4 class="mb-0 fw-bold"><?php echo e(($totalItems ?? 0) - ($outOfStockCount ?? 0)); ?></h4>
                            ...
                            <div class="col-md-4">
                                <div class="stat-card">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h4 class="mb-0 fw-bold"><?php echo e($lowStockCount ?? 0); ?></h4>
                            ...
                            <div class="col-md-4">
                                <div class="stat-card">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h4 class="mb-0 fw-bold"><?php echo e($outOfStockCount ?? 0); ?></h4>
                        ...
                        <div class="progress-modern mb-2">
                            <div class="progress-bar-modern" style="width: <?php echo e($healthPercentage); ?>%; --gradient: var(--gradient-success);"></div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="glass-card p-4">
                        ...
                        <div class="d-grid gap-3">
                            <a href="<?php echo e(route('inventory.items.create')); ?>" class="action-button text-decoration-none" style="--gradient: var(--gradient-primary);">
                            ...
                            <a href="<?php echo e(route('inventory.items.index')); ?>" class="action-button text-decoration-none" style="--gradient: var(--gradient-info);">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <a href="<?php echo e(route('inventory.loans.create')); ?>" class="action-button text-decoration-none" style="--gradient: var(--gradient-success);">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <a href="<?php echo e(route('inventory.loans.index')); ?>" class="action-button text-decoration-none" style="--gradient: var(--gradient-warning);">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\Natanem\resources\views/dashboards/inventory.blade.php ENDPATH**/ ?>