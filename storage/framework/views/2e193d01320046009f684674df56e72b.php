...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('build/assets/app.css')); ?>?v=<?php echo e(file_exists(public_path('build/assets/app.css')) ? filemtime(public_path('build/assets/app.css')) : 0); ?>">
  <script type="module" src="<?php echo e(asset('build/assets/app.js')); ?>?v=<?php echo e(file_exists(public_path('build/assets/app.js')) ? filemtime(public_path('build/assets/app.js')) : 0); ?>"></script>
  <style>
      :root {
          /* Theme colors */
          --erp-green:  #73AF6F;
