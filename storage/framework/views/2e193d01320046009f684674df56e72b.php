...
<main class="<?php echo e(Auth::check() ? 'main-content' : 'min-vh-100'); ?>">
  <div class="<?php echo e(Auth::check() ? 'container-fluid' : ''); ?>">
  ...
  <script>
    ...
    const paletteLinks = [
        { name: 'Dashboard Overview', url: '<?php echo e(route("home")); ?>', icon: 'bi-speedometer2' },
        { name: 'Human Resource Hub', url: '<?php echo e(route("hr.dashboard")); ?>', icon: 'bi-people' },
        { name: 'Inventory Manager', url: '<?php echo e(route("inventory.dashboard")); ?>', icon: 'bi-boxes' },
