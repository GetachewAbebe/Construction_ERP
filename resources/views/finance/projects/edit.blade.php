@extends('layouts.app')
@section('title', 'Refine Site - ' . $project->name)
...
<div class="mb-5">
    <div class="row align-items-center g-3">
        <div class="col-md">
            <span class="text-uppercase tracking-wider text-muted font-bold small d-block mb-1" style="font-size: 0.75rem; letter-spacing: 0.1em;">System Modification</span>
            <h1 class="display-4 fw-900 text-erp-deep mb-0 tracking-tight" style="letter-spacing: -0.03em;">Site Refinement</h1>
            <p class="text-muted small mb-0 mt-1">Adjust parameters, budget allocations, and operational status for <strong class="text-dark">{{ $project->name }}</strong>.</p>
        </div>
...
<!-- Core Enterprise Form Architecture -->
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="status" class="form-select erp-input @error('status') is-invalid @enderror">
                        <option value="operational" @selected(old('status', $project->status) == 'operational' || old('status', $project->status) == 'active')>Live / Operational</option>
                        ...
                        <option value="cancelled" @selected(old('status', $project->status) == 'cancelled')>Terminated</option>
                    </select>
            ...
            <div class="row g-4">
                <div class="col-12">
                    ...
                    <textarea name="description" rows="4" 
                              ...
                              placeholder="Describe the main architectural objectives and engineering scope of this project site...">{{ old('description', $project->description) }}</textarea>
