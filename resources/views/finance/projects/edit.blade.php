...
<div class="row align-items-center mb-4 stagger-entrance">
    <div class="col">
        <h1 class="h3 mb-1 fw-800 text-erp-deep">Edit Project</h1>
        <p class="text-muted mb-0">Update details for project: <span class="text-erp-deep fw-800">{{ $project->name }}</span></p>
    </div>
    <div class="col-auto">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="4" 
                                          ...
                                          placeholder="Project details, scope, or notes...">{{ old('description', $project->description) }}</textarea>
