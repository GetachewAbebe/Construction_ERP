@extends('layouts.app')
@section('title', 'Refine Project Details')

@section('content')
<div class="row align-items-center mb-4 stagger-entrance">
    <div class="col">
        <h1 class="h3 mb-1 fw-800 text-erp-deep">Modify Project Details</h1>
        <p class="text-muted mb-0">Update configuration for: <span class="text-erp-deep fw-800">{{ $project->name }}</span></p>
    </div>
    <div class="col-auto">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select border-0 bg-light-soft rounded-4 py-3 px-4 shadow-sm @error('status') is-invalid @enderror">
                                    <option value="active" @selected(old('status', $project->status) == 'active')>Active - In Construction</option>
                                    <option value="on_hold" @selected(old('status', $project->status) == 'on_hold')>On Hold - Temporary Pause</option>
                                    <option value="completed" @selected(old('status', $project->status) == 'completed')>Completed - Site Handover</option>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="4" 
                                          ...
                                          placeholder="Outline goals, scope, and initial requirements...">{{ old('description', $project->description) }}</textarea>
