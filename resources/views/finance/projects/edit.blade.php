...
<div class="page-header-premium mb-4">
    <div class="row align-items-center">
        <div class="col">
            <h1 class="display-6">Site Refinement</h1>
            <p>Adjust site parameters, budget, and operational status for <strong>{{ $project->name }}</strong>.</p>
        </div>
        <div class="col-auto">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="status" class="form-select erp-input @error('status') is-invalid @enderror">
                        <option value="active" @selected(old('status', $project->status) == 'active')>Live / Active</option>
            ...
            <div class="row g-4">
                <div class="col-12">
                    ...
                    <textarea name="description" rows="4" 
                              ...
                              placeholder="Describe the main objectives and scope of this construction project...">{{ old('description', $project->description) }}</textarea>
