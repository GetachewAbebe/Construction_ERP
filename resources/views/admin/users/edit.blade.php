                    ...
                    <div class="row g-4 mb-5">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="first_name" value="{{ old('first_name', $user->first_name) }}" required placeholder="e.g. Abebe"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0"><i class="bi bi-person text-secondary"></i></span>
                                <input name="middle_name" value="{{ old('middle_name', $user->middle_name) }}" placeholder="e.g. Kebede"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0"><i class="bi bi-person text-secondary"></i></span>
                                <input name="last_name" value="{{ old('last_name', $user->last_name) }}" required placeholder="e.g. Tesfaye"
