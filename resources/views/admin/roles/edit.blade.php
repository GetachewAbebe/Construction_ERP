<x-layouts.app-shell title="Edit Role">
    <div class="mx-auto max-w-3xl space-y-5">
        <div class="flex items-center justify-between gap-3">
            <div>
                <h2 class="text-xl font-semibold">Edit Role</h2>
                <p class="text-sm text-base-content/60">Reconfigure <span class="font-medium text-base-content">{{ $role->name }}</span> and its permissions.</p>
            </div>
            ...
            <div>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input name="name" value="{{ old('name', $role->name) }}" required class="input input-bordered w-full {{ $errors->has('name') ? 'input-error' : '' }}" />
