...
import { UserPlus, ArrowLeft, Shield, Mail, Lock, Phone, Building2 } from 'lucide-react';

export default function Create({ roles = [], employee = null }) {
    ...
    return (
        <AuthenticatedLayout title="Provision User Account" header="Administration">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                Issue access credentials, assign security roles, and link employee identities.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs space-y-6">
                        ...
                        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3">
                            ...
                            >
                                ...
                                <span>{processing ? 'Provisioning...' : 'Provision User'}</span>
                            </button>
                        </div>
                    </div>
                </form>
