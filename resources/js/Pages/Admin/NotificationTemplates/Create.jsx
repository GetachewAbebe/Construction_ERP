...
import { ArrowLeft, Save, Mail, Bell, MessageSquare, Info } from 'lucide-react';
...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout title="New Template" header="System Administration">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="text-xl sm:text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">
                                Provision Communication Template
                            </h1>
                            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
                                Configure copy parameters and dynamic interpolations for system events.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    required
                                    placeholder="e.g. leave_approved or expense_rejected"
                                    value={data.key}
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    placeholder="e.g. Decision Notice: Leave Request #{{ id }}"
                                    value={data.subject}
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder="name, amount, date, decision, note"
                            ...
                            <p className="text-[11px] text-slate-400 mt-1">
                                Use inside body as double-braces: <code>&#123;&#123; name &#125;&#125;</code>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                rows={7}
                                required
                                placeholder="Write the content template here. Example: Dear {{ name }}, your request has been approved on {{ date }}."
                                value={data.body}
                        ...
                        <label className="flex items-center gap-2 text-xs font-semibold text-slate-700 dark:text-slate-300 cursor-pointer select-none">
                            ...
                            />
                            <span>Active template (operational immediately upon dispatch)</span>
                        </label>
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        >
                            ...
                            <span>{processing ? 'Provisioning...' : 'Provision Template'}</span>
                        </button>
                    </div>
                </form>
            </div>
